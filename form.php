...
if ($_POST) {
    ...
    if (empty($_POST['courriel'])) {
        $errors['courriel1'] = "Veuillez renseigner votre adresse e-mail";
    }
    ...
    if (0 == count($errors)) {
        echo "Votre message à été envoyez avec succès !";
        $_POST = "";
    }
...
<form action="" method="post">
    ...
    <div>
        ...
        <input type="email" id="courriel" name="courriel" value="<?php if(isset($_POST['email'])) echo $_POST['email'];?> "/>
    ...
    <div>
        ...
        <input type="tel" pattern="\d+" id="tel" name="tel" value="<?php if(isset($_POST['tel'])) echo $_POST['tel'];?>"/>
